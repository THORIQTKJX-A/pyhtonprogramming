...
for i in range(jumlah_set) :
    ...
    if total_uang > target_uang :
        print(f"target jumlah uang Rp. {target_uang} telah tercapai total uang sebesar Rp. {total_uang}")
    elif total_uang < target_uang :
        print(f"target jumlah uang Rp. {target_uang} telah tercapai total uang sebesar Rp. {total_uang}")
    else:
        print(f"target jumlah uang Rp. {target_uang} sesuai dengan total uang sebesar Rp. {total_uang}b")